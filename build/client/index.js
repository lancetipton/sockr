...
const useSockrReducer = (customReducer, customInitialState) => {
  const [state, dispatch] = React.useReducer(joinReducers(sockrReducer, customReducer), deepMerge(initialState$1, customInitialState));
...
exports.__moduleExports = constants;
